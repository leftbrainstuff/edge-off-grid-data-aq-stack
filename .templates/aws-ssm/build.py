...
def main():
  ...
  def preBuild():
    ...
    print("[aws-ssm]: ", execComm) # --- Ensure to update the service name with yours
...
global currentServiceName # Name of the current service
if currentServiceName == 'aws-ssm': # --- Ensure to update the service name with yours
  main()
else:
  print("Error. '{}' Tried to run 'aws-ssm' config".format(currentServiceName)) # --- Ensure to update the service name with yours
