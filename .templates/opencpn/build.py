...
=======
  ...
  def mainRender(menu, selection):
    ...
    print(term.black_on_cornsilk4(term.center('IOTstack Opencpn Commands')))
    print("")
  ...
  def runSelection(selection):
    ...
    if len(menuItemsExample[selection]) > 1 and isinstance(menuItemsExample[selection][1], types.FunctionType):
      ...
      print(term.green_reverse('IOTstack Opencpn Error: No function assigned to menu item: "{}"'.format(menuItemsExample[selection][0])))
